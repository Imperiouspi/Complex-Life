				...
				if (i < Life.size()) { // In case the size of Life was changed
					...
					case "Lion":
						breedingEnabled = aWindow.lionSet.trueBreed
								.isSelected();
						aWindow.lionSet.cool_Sl
								.setValue(aWindow.lionSet.cool_Sl.getValue() - 1);
						breedCooldown = aWindow.lionSet.cool_Sl.getValue();
						break;
					case "Horse":
						breedingEnabled = aWindow.horseSet.trueBreed
								.isSelected();
						aWindow.horseSet.cool_Sl
								.setValue(aWindow.horseSet.cool_Sl.getValue() - 1);
						breedCooldown = aWindow.horseSet.cool_Sl.getValue();
						break;
					case "Mountain Goat":
						breedingEnabled = aWindow.mGoatSet.trueBreed
								.isSelected();
						aWindow.mGoatSet.cool_Sl
								.setValue(aWindow.mGoatSet.cool_Sl.getValue() - 1);
