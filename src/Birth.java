...
public class Birth {
	...
	public static void main(String[] args) {
		...
		JTextArea helpText = new JTextArea("How to play:"
			...
			+"\n- The countdown is how long the animal has to wait before breeding again."
			...
			+"\n- Click on an animal in the world to see its icon and statistics on the right"
			+"\n- At the bottom is displayed the number of animals left, and some news based on\n   what is happening in the world.");
